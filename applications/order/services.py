...
from applications.vehicles.models import VehicleType, Vehicle
from core.models import GeneralConfig, City, VipZone, VipZoneKilometerRule
from .models import (
...
class PaymentService:
    ...
    def _process_wallet_payment(self, order: Order, amount: Decimal) -> Dict:
        ...
        """
        from applications.users.models import Wallet
