...
INSTALLED_APPS = [
    ...
    'applications.wallet.apps.WalletConfig',
]
...
ROOT_URLCONF = 'woila_project.urls'
...
WSGI_APPLICATION = 'woila_project.wsgi.application'
ASGI_APPLICATION = 'woila_project.asgi.application'
...
MIGRATION_MODULES = {
    ...
    'applications.authentication': 'migrations.authentication',
    'applications.users': 'migrations.users',
    'applications.vehicles': 'migrations.vehicles',
    'applications.notifications': 'migrations.notifications',
    'applications.wallet': 'migrations.wallet',
    'applications.order': 'migrations.order',
    'admin': 'migrations.admin',
    'auth': 'migrations.auth',
    'contenttypes': 'migrations.contenttypes',
    'sessions': 'migrations.sessions',
    'messages': 'migrations.messages',
}
