...
class UserDriverDetailSerializer(serializers.ModelSerializer):
    ...
    def get_documents_count(self, obj) -> int:
        ...
        return Document.objects.filter(user_id=obj.id, user_type=user_content_type).count()
...
class DocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Document
        fields = [
            'id', 'user_id', 'user_type', 'user_name', 'user_phone', 'user_type_display',
            'document_name', 'file', 'file_url', 'original_filename', 'file_size',
            'file_size_display', 'content_type', 'uploaded_at', 'is_active'
        ]
        read_only_fields = [
            'id', 'original_filename', 'file_size', 'content_type',
            'uploaded_at', 'file_url', 'file_size_display', 'user_name',
            'user_phone', 'user_type_display'
        ]
